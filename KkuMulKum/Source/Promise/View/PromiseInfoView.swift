...
class PromiseInfoView: BaseView {
    private let participantNumberLabel: UILabel = UILabel().then {
        ...
        $0.setHighlightText("n명", style: .body01)
    }
    ...
    private let promiseInfoLabel: UILabel = UILabel().then {
        $0.setText("약속 상세 정보", style: .body01)
    }
    ...
    private let locationContentLabel: UILabel = UILabel().then {
        $0.setText("sss역 s번 출구", style: .body04)
    }
    ...
    private let timeContentLabel: UILabel = UILabel().then {
        $0.setText("mm월 dd일 hh:mm", style: .body04)
    }
    ...
    private let readyLevelContentLabel: UILabel = UILabel().then {
        $0.setText("LV n. sss", style: .body04)
    }
    ...
    override func setupAutoLayout() {
        ...
        participantCollectionView.snp.makeConstraints {
            $0.top.equalTo(participantNumberLabel.snp.bottom).offset(17)
        ...
        backgroundView.snp.makeConstraints {
            $0.top.equalTo(participantCollectionView.snp.bottom).offset(23)
        ...
        promiseInfoBackgroundView.snp.makeConstraints {
            $0.top.equalTo(promiseInfoLabel.snp.bottom).offset(16)
            $0.leading.trailing.equalToSuperview().inset(20)
            $0.height.equalTo(278)
        }
        
        locationInfoLabel.snp.makeConstraints {
            $0.top.leading.equalTo(promiseInfoBackgroundView).offset(12)
        }
        ...
        locationDivideView.snp.makeConstraints {
            $0.top.equalTo(locationContentLabel.snp.bottom).offset(13)
            $0.leading.trailing.equalTo(promiseInfoBackgroundView).inset(12)
            $0.height.equalTo(1)
        }
        
        timeInfoLabel.snp.makeConstraints {
            $0.top.equalTo(locationDivideView.snp.top).offset(12)
        ...
        timeDivideView.snp.makeConstraints {
            $0.top.equalTo(timeContentLabel.snp.bottom).offset(13)
            $0.leading.trailing.equalTo(promiseInfoBackgroundView).inset(12)
            $0.height.equalTo(1)
        }
        
        readyLevelInfoLabel.snp.makeConstraints {
            $0.top.equalTo(timeDivideView.snp.top).offset(12)
        ...
        readyLevelDivideView.snp.makeConstraints {
            $0.top.equalTo(readyLevelContentLabel.snp.bottom).offset(13)
            $0.leading.trailing.equalTo(promiseInfoBackgroundView).inset(12)
            $0.height.equalTo(1)
        }
        
        penaltyLevelInfoLabel.snp.makeConstraints {
            $0.top.equalTo(readyLevelDivideView.snp.top).offset(12)
            $0.leading.equalTo(timeDivideView)
        }
